...
public class ExampleTest {
    ...
    public void setUp() {
        ...
        expectedReverse4 = "!lluf s'draykcab ym ,draykcab ym ni hsart ruoy worht t'noD";
    }
    ...
    public void testReverseMessage4() {
        String actual = main.reverse("Don't throw your trash in my backyard, my backyard's full!");
